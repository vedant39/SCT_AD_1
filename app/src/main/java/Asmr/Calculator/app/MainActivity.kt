                ...
                Surface(
                    ...
                    Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.TopCenter){
                        ...
                        Icon( modifier = Modifier.size(20.dp),
                            ...
                            tint = Color.White)
                        Icon(painter = painterResource(id = R.drawable.lightmode) , contentDescription = null , tint = Color.White )
                        }
                    }
            }
        }
        ...
        Box(modifier = Modifier
            ...
            if(button.text != null){
                Text(
                    ...
                    fontSize = if(button.type == CalculatorButtonType.Action)25.sp
                    else
                        20.sp
                )
